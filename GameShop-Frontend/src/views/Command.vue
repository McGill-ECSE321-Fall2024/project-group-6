    ...
    <div>
      ...
      <div class="command">
        ...
        <div class="receipt" v-if="command">
          <div class="id">Order number: {{ command.id }}</div>
          <div class="list">
            <div class="order">
                <h5>Items:</h5>
              <div v-for="game in command.games" :key="game.id" class="game-row">
              ...
              <div class="payement">
                <strong>Payment:</strong> {{ selectedPayement.number }}
              </div>
            </div>
...
export default {
    data() {
        return {
            ...
            customer: {
                shippingAddress: "123 Main St, Montreal, QC",
            },
            selectedPayement: {
                number: "**** **** **** 1234",
            },
    ...
    computed: {
        totalPrice() {
            return this.command.games.reduce((total, game) => total + game.price, 0);
        },
    },
};
</script>
