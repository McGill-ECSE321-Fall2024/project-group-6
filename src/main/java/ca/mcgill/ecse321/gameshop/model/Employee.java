...
public class Employee extends Role
{
    ...
    public Game addCreated(String aName, String aDescription, float aPrice, int aStockQuantity, Image aPhoto, int aGameId, Manager aManager, Category... allCategories)
    {
        return new Game(aName, aDescription, aPrice, aStockQuantity, aPhoto, aGameId, aManager, this, allCategories);
    }
