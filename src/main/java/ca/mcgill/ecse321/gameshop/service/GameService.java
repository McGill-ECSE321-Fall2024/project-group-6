...
public class GameService {
    ...
    @Transactional
    public Game addGame(String aName, String aDescription, float aPrice, int aStockQuantity, String aPhotoURL, boolean toBeAdded, boolean toBeRemoved, float promotion, Category... allCategories) {
        if(aName==null){
