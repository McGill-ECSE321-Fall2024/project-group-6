...
/*
    ...
    @Test
    @Order(1)
    public void testCreateCategoryToUse() {
        // Arrange


        // Act
        ResponseEntity<CategoryResponseDto> response = client.postForEntity("/categories", category1, CategoryResponseDto.class);
        ResponseEntity<CategoryResponseDto> response2 = client.postForEntity("/categories", category2, CategoryResponseDto.class);
        ...
        assertEquals(category1, response.getBody().getName());
        assertEquals(category2, response2.getBody().getName());
    }
    @Test
    @Order(2)
